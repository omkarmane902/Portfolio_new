...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Modern, responsive portfolio website with dark mode, animations, and contact form.",
      image: <img src={portfolioImage} alt="Portfolio" />,
      category: "frontend",
    ...
    },
    {
      ...
      description: "Collaborative task management application with real-time updates, task boards, and team features.",
      image: "📋",
      category: "fullstack",
    ...
    },
    {
      ...
      description: "Real-time weather application with interactive maps, forecasts, and location-based services.",
      image: "🌤️",
      category: "frontend",
    ...
    },
    {
      id: 5,
      title: "Blog Platform",
      description: "Full-stack blog platform with user authentication, rich text editor, and comment system.",
      image: "📝",
      category: "fullstack",
      tech: ["React", "Node.js", "Express", "MongoDB", "Tailwind CSS"],
      icons: [FaReact, FaNodeJs, SiExpress, SiMongodb, SiTailwindcss],
    ...
    },
    {
      ...
      description: "Real-time chat application with private rooms, file sharing, and video call features.",
      image: "💬",
      category: "backend",
  ...
  return (
    <section id="projects" className="relative py-16 sm:py-20 md:py-24 lg:py-28 bg-[#06070d] overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="mt-4 sm:mt-6 text-3xl sm:text-4xl md:text-5xl font-extrabold text-white">
            My <span className="bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent">Projects</span>
          </h2>
...
const ProjectCard = ({ project, index, featured }) => {
  return (
    ...
    >
      {/* Gradient Overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-purple-600/5 to-cyan-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

      {/* Project Image/Icon */}
      <div className="relative h-48 flex items-center justify-center text-6xl bg-gradient-to-br from-purple-900/20 to-cyan-900/20">
